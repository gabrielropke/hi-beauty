...
class TeamColorSelector extends StatefulWidget {
  final Color initial;
  ...
  @override
  State<TeamColorSelector> createState() => _TeamColorSelectorState();
}

class _TeamColorSelectorState extends State<TeamColorSelector> {
