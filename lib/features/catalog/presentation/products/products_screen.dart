...
import 'package:hibeauty/features/catalog/presentation/components/filters_drawer.dart';
import 'package:hibeauty/features/catalog/presentation/components/products_list.dart';
...
class _ProductsViewState extends State<ProductsView> {
  ...
  static const List<String> locationTypeOptions = ['IN_PERSON', 'REMOTE', 'HYBRID'];
  ...
  List<ProductsModel> _filtered(CatalogLoaded state) {
    final q = _searchCtrl.text.trim().toLowerCase();
    var list = state.products.where((s) {
      final matchesQuery =
          q.isEmpty ||
      ...
      final matchesLocationType =
          _selectedLocationType.isEmpty;
      return matchesQuery && matchesActiveStatus && matchesVisibility && matchesLocationType;
    }).toList();
