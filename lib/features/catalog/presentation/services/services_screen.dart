...
class _ServicesViewState extends State<ServicesView> {
  ...
  List<ServicesModel> _filtered(CatalogLoaded state) {
    final q = _searchCtrl.text.trim().toLowerCase();
    var list = state.services.where((s) {
      final matchesQuery =
          q.isEmpty ||
      ...
      final matchesLocationType =
          ...
          _selectedLocationType.contains(s.locationType);
  ...
  Widget _loaded(
    ...
    final services = _filtered(state);
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ServicesList(services: services, state: state),
